...
export default class GeoWorld3 {
  ...
  private mainModel: Mesh | undefined;
  private trayModel: Mesh | undefined;
  private frameX: number = 1;
  private waveTexture: Texture | undefined;
